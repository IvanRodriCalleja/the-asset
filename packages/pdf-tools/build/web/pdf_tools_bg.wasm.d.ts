...
export function decrypt_pdf(a: number, b: number, c: number, d: number): number;
...
export function getthumbnailresult_new(a: number, b: number, c: number, d: number, e: number): number;
