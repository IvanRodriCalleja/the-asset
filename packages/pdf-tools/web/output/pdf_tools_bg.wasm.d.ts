...
export function addfileinput_new(a: number, b: number, c: number, d: number, e: number): number;
export function addfileinput_id(a: number): number;
export function addfileinput_buffer(a: number, b: number): void;
export function addfileinput_name(a: number, b: number): void;
export function __wbg_addfileresult_free(a: number, b: number): void;
...
export function pdftools_remove_file(a: number, b: number): void;
export function pdftools_get_total_pages(a: number, b: number, c: number): void;
export function pdftools_rotate_pdf(a: number, b: number, c: number, d: number): void;
export function pdftools_rotate_pdf_page(a: number, b: number, c: number, d: number, e: number): void;
...
export function fileoperationresult_new(a: number, b: number, c: number): number;
export function fileoperationresult_id(a: number): number;
