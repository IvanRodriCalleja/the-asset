...
export function __wbg_mergetoolmanager_free(a: number, b: number): void;
...
export function mergetoolmanager_remove_pdf_page(a: number, b: number, c: number, d: number): number;
export function mergetoolmanager_decrypt_pdf(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function mergetoolmanager_merge_files(a: number, b: number, c: number): number;
export function mergetoolmanager_get_file_size(a: number, b: number, c: number, d: number): void;
export function mergetoolmanager_get_file(a: number, b: number, c: number, d: number): void;
