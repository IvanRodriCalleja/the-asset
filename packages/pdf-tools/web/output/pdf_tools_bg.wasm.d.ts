...
export function pdftools_get_total_pages(a: number, b: number, c: number): number;
export function pdftools_rotate_pdf(a: number, b: number, c: number, d: number): number;
export function pdftools_rotate_pdf_page(a: number, b: number, c: number, d: number, e: number): number;
export function pdftools_remove_pdf_page(a: number, b: number, c: number, d: number): number;
