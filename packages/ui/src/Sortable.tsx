...
interface SortableOverlayProps extends ComponentPropsWithRef<typeof DragOverlay> {
...
const SortableItem = forwardRef<HTMLDivElement, SortableItemProps>(
	({ value, asTrigger, asChild, className, ...props }, ref) => {
		...
		const grabClassName = cursorGrab({ dragging: isDragging, grab: !isDragging && asTrigger });
